...
def home(request):
    ...
    # ถ้าไม่มีการส่งค่าใน GET request
    try:
    ...
    # ดึงข้อมูลที่เกี่ยวข้องกับ repair_type
    repair_data = (
        ServiceRequest.objects
        .filter(date_received__month=month, date_received__year=year)
        .values("repair_type__name", "repair_title__name", "repair_by")
        .annotate(
